...
class NeutralPrompt(Prompt):
    def __init__(self, prompt_keys: List[str]):
        ...
        self.prompt_text = f'\n\nExtract {self._key_list_to_string(self.prompt_keys)} from the document above. If you can\'t find a key-value pair in the document set the value to "null".\n\nKey: Value\n{self.prompt_keys[0]}:'
    ...
    # def remove_prompt_from_model_input(self, model_input: str) -> str:
    #     return model_input[:-self.prompt_char_length]
